...
DATASETS = {
    "crop_recommendation.csv": "https://raw.githubusercontent.com/Gladiator07/Harvestify/master/Data-raw/crop_recommendation.csv",
...
print("\n[Step 2] Training all models + printing comparison table...")
from src.train import main as train_main
train_main()

print("\n[Step 3] Evaluating + saving plots...")
